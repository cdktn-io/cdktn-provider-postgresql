...
```go
import "github.com/cdktn-io/cdktn-provider-postgresql-go/postgresql/v15/grantrole"
...
| <code><a href="#@cdktn/provider-postgresql.grantRole.GrantRoleConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyrilgdn/postgresql/1.27.0/docs/resources/grant_role#id GrantRole#id}. |
