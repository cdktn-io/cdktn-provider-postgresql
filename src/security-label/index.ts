...
// https://registry.terraform.io/providers/cyrilgdn/postgresql/1.27.0/docs/resources/security_label
...
export class SecurityLabel extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityLabel that should be imported. Refer to the {@link https://registry.terraform.io/providers/cyrilgdn/postgresql/1.27.0/docs/resources/security_label#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cyrilgdn/postgresql/1.27.0/docs/resources/security_label postgresql_security_label} Resource
  *
  * @param scope The scope in which to define this construct
