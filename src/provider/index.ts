...
// https://registry.terraform.io/providers/cyrilgdn/postgresql/1.27.0/docs
...
export class PostgresqlProvider extends cdktn.TerraformProvider {
  ...
  * @param importFromId The id of the existing PostgresqlProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/cyrilgdn/postgresql/1.27.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cyrilgdn/postgresql/1.27.0/docs postgresql} Resource
  *
  * @param scope The scope in which to define this construct
