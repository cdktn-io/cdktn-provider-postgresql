...
// https://registry.terraform.io/providers/cyrilgdn/postgresql/1.27.0/docs/resources/replication_slot
...
export class ReplicationSlot extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ReplicationSlot that should be imported. Refer to the {@link https://registry.terraform.io/providers/cyrilgdn/postgresql/1.27.0/docs/resources/replication_slot#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cyrilgdn/postgresql/1.27.0/docs/resources/replication_slot postgresql_replication_slot} Resource
  *
  * @param scope The scope in which to define this construct
