...
// https://registry.terraform.io/providers/cyrilgdn/postgresql/1.27.0/docs/resources/user_mapping
...
export class UserMapping extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing UserMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/cyrilgdn/postgresql/1.27.0/docs/resources/user_mapping#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cyrilgdn/postgresql/1.27.0/docs/resources/user_mapping postgresql_user_mapping} Resource
  *
  * @param scope The scope in which to define this construct
