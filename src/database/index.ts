...
// https://registry.terraform.io/providers/cyrilgdn/postgresql/1.26.0/docs/resources/database
...
export class Database extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: DatabaseConfig) {
    ...
    this._alterObjectOwnership = config.alterObjectOwnership;
  ...
  public resetAlterObjectOwnership() {
    this._alterObjectOwnership = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get alterObjectOwnershipInput() {
    return this._alterObjectOwnership;
  }
