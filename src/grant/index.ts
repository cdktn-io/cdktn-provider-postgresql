...
// https://registry.terraform.io/providers/cyrilgdn/postgresql/1.27.0/docs/resources/grant
...
export class Grant extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Grant that should be imported. Refer to the {@link https://registry.terraform.io/providers/cyrilgdn/postgresql/1.27.0/docs/resources/grant#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cyrilgdn/postgresql/1.27.0/docs/resources/grant postgresql_grant} Resource
  *
  * @param scope The scope in which to define this construct
